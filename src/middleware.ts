...
export default async function middleware(
  ...
  //     }
  //   } catch (error) {
  //     // Log error but continue with request to avoid blocking legitimate traffic
  ...
  // Ensure the response is returned properly
  if (!response) {
    // Fallback response if i18n routing fails
